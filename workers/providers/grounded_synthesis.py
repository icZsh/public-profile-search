...
_DEADLINE_FREE_CONNECT_TIMEOUT_SECONDS = 10.0
_DEADLINE_FREE_READ_TIMEOUT_SECONDS = 5 * 60.0
_DEADLINE_FREE_WRITE_TIMEOUT_SECONDS = 30.0
_DEADLINE_FREE_POOL_TIMEOUT_SECONDS = 10.0
    ...
    *,
    ...
    timeout = (
        ...
        if timeout_seconds is not None
            ...
            connect=_DEADLINE_FREE_CONNECT_TIMEOUT_SECONDS,
            read=_DEADLINE_FREE_READ_TIMEOUT_SECONDS,
            write=_DEADLINE_FREE_WRITE_TIMEOUT_SECONDS,
            pool=_DEADLINE_FREE_POOL_TIMEOUT_SECONDS,
        )
    )
